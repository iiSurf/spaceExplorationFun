// TODO: The Solar System, part 1
 

const solarSystem = [
    { name: "Mercury", ringSystem: false, moons: [] },
    { name: "Venus", ringSystem: false, moons: [] },
    { name: "Earth", ringSystem: false, moons: ["The Moon (aka La Luna"] },
...
for (const ring of solarSystem) {
    if (ring.ringSystem) {
        console.log(ring);
    }
}

//TODO: The Solar System, Part 2
...
const system = {
    ...
    const numOfSatelites = parseInt(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites;
    console.log(numOfSatelites);
    ...
    const differenceOfMomentum = jupiterMomentum - plutoMomentum;
    console.log(differenceOfMomentum, 'is the differance of momentum between Jupiters momentum and Plutos momentum!' );